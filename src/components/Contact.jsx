const Contact = () => {
    return ( 
        <div id="contact" className="max-w-[1040px] m-auto md:pl-20 p-4 py-16">
            ...
            <form action="https://getform.io/f/23f76bae-754f-4012-8a22-24029e3643db" method="POST" encType="multipart/form-data">
                <div className="grid md:grid-cols-2 gap-4 w-full py-2">
                    ...
                    <div className="flex flex-col py-2">
                        ...
                        <input className="border-2 rounder-lg p-3 flex" type="text" name="Subject" />
                    </div>
                </div>
                 <div className="flex flex-col py-2">
